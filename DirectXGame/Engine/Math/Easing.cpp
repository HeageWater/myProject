...
double Easing::EaseInOut(const double startpos, const double endpos, float time, float num)
{
	if (time < 0.5)
	{
...
double Easing::EaseInBack(const double startpos, const double endpos, float time, float num, double p1)
{
	const double c1 = p1;
...
double Easing::EaseIn(const double start, const double end, const double time, float num)
{
	return lerp(start, end, pow(time, num));
}

double Easing::EaseOut(const double start, const double end, const double time, float num)
{
