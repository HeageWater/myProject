...
void PostEffect::PreDraw(ID3D12GraphicsCommandList* cmdList)
{
	...
	rect.left = (long)0.0f;
	rect.top = (long)0.0f;
	rect.right = Window::window_width;
	rect.bottom = Window::window_height;
...
void PostEffect::Initialize()
{
	...
	const UINT pixelCount = Window::window_width * Window::window_height;

	const UINT rowPitch = sizeof(UINT) * Window::window_width;

	const UINT deathPitch = rowPitch * Window::window_height;
